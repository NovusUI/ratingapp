...
const ShareOnTwitter = ({toiletName,setShowOtherRating}) => {
  ...
  return (
    <div className='island' style={(mode === "light" &&{backgroundColor:"#d0dbff", position:"relative"})||{position:"relative"}}>
      <CancelBtn onClick={()=>setShowOtherRating(false)}/>
      <TitleDiv title="Share your view" subtitle={"#" + toiletName}/>
        
      <div style={( mode ==="light"&& {...styles.btn ,backgroundColor:"#b9c3e3",color: "#444444", display:"flex", justifyContent:"center",alignItems:"center"})|| styles.btn} className='inter-15px-300' onClick={shareOnTwitter}>
        <p>Share on </p>
